...
class ReportExecutionLogController(Controller):
    ...
    # Every report-log endpoint returns 404 when ALERT_REPORTS feature flag is disabled.
    ...
    async def get_single(
        ...
        # The lookup is by log_id only (no base_filters on this API), so a valid
        # log_id belonging to a different report schedule than pk returns 200, not 404.
