...
# under the License.
"""SSH tunnel model (pure SQLAlchemy, no legacy WSGI dependencies)."""
...
class SSHTunnel(AuditMixinNullable, ExtraJSONMixin, ImportExportMixin, Base):
    """SSH tunnel configuration for a database connection."""
