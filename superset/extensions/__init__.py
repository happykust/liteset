...
* ``ssh_manager_factory`` — factory holder for the configured
  :class:`~superset.extensions.ssh.SSHManager` instance.  Initialised
  by :func:`superset.app.on_startup` from the
  :setting:`SSH_TUNNEL_MANAGER_CLASS` setting.
"""
