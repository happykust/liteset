...
class CssTemplatePutSchema(msgspec.Struct):
    """PUT /api/v1/css_template/<pk>"""

    template_name: str | None | msgspec.UnsetType = msgspec.UNSET
...
class CssTemplateResponseSchema(msgspec.Struct):
    """Single CSS template response."""
