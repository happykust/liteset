...
flowchart TD
  ...
  subgraph WebServers ["<b>Web Server(s)</b>"]
    ...
    WS2["<b>Backend</b><br/>(Python, Litestar/ASGI, SQLAlchemy 2.0 async, asyncpg, Pandas, ...)"]
  end
...
[Download the .svg](https://github.com/happykust/liteset/tree/main/docs/static/img/erd.svg)
