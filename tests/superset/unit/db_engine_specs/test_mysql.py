...
# under the License.
"""Native Liteset port of the upstream sync MySQLEngineSpec unit tests.
...
@pytest.mark.skipif(
    importlib.util.find_spec("MySQLdb") is None,
    reason="requires the mysqlclient (MySQLdb) driver for type-code lookup",
)
@pytest.mark.parametrize(
