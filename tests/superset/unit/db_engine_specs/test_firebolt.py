...
# under the License.
"""Native Liteset port of the upstream sync FireboltEngineSpec unit tests.

Tests the synchronous ``superset.db_engine_specs.firebolt`` spec. Flask-free:
...
from superset.db_engine_specs.firebolt import FireboltEngineSpec as spec  # noqa: N813
