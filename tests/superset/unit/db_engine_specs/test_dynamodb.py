...
# under the License.
"""Native Liteset port of the upstream sync DynamoDBEngineSpec unit tests.

Tests the synchronous ``superset.db_engine_specs.dynamodb`` spec. Flask-free:
...
from superset.db_engine_specs.dynamodb import DynamoDBEngineSpec as spec  # noqa: N813
