...
# under the License.
"""Native Liteset port of the upstream sync PostgresEngineSpec unit tests.

Tests the synchronous ``superset.db_engine_specs.postgres`` spec used for
metadata / SQL generation. Flask-free: no flask, flask_appbuilder or werkzeug.
"""
