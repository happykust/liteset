...
# under the License.
"""Native Liteset port of the upstream sync HiveEngineSpec unit tests.

Tests the synchronous ``superset.db_engine_specs.hive`` spec. Flask-free: no
flask, flask_appbuilder or werkzeug.
"""
...
def test_convert_dttm(
    ...
    assert_convert_dttm(HiveEngineSpec, target_type, expected_result, dttm)
