...
# under the License.
"""Native Liteset port of the upstream sync DenodoEngineSpec unit tests.

Tests the synchronous ``superset.db_engine_specs.denodo`` spec. Flask-free: no
flask, flask_appbuilder or werkzeug imports.
"""
