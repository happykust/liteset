...
# under the License.
"""Native Liteset port of the upstream sync PinotEngineSpec unit tests.

Flask-free: no flask, flask_appbuilder or werkzeug. The integration-test
fixture ``default_db_extra`` is inlined here as a plain string constant to
avoid pulling in the Flask app.
"""
