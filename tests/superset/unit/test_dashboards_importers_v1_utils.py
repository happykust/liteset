...
def test_update_id_refs_immune_missing() -> None:
    """
...
def test_update_native_filter_config_scope_excluded() -> None:
    config = {
        "position": {
            "CHART1": {
                "id": "CHART1",
...
def test_update_id_refs_cross_filter_handles_string_excluded() -> None:
    config: dict[str, Any] = {
        "position": {
            "CHART1": {
                "id": "CHART1",
