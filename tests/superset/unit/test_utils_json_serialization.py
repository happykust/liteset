...
from superset.utils.core import zlib_compress, zlib_decompress
...
def test_json_loads_exception() -> None:
...
def test_json_loads_encoding() -> None:
...
def test_json_loads_allow_nan() -> None:
...
def test_json_dumps_encoding() -> None:
    data = {
        "utf8": b"Hello World",
...
def test_json_iso_dttm_ser() -> None:
    data = {
...
def test_pessimistic_json_iso_dttm_ser() -> None:
    data = {
        "datetime": datetime(2021, 1, 1, 0, 0, 0),
        "date": date(2021, 1, 1),
    }
...
def test_pessimistic_json_iso_dttm_ser_nonutf8() -> None:
    data = {
...
def test_pessimistic_json_iso_dttm_ser_utf16() -> None:
    data = {
...
def test_zlib_compression() -> None:
    json_str = '{"test": 1}'
...
def test_json_int_dttm_ser() -> None:
    dttm = datetime(2020, 1, 1)
    ts = 1577836800000.0
