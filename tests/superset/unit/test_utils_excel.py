...
def test_column_data_types_with_one_numeric_column() -> None:
    df = pd.DataFrame(
        {
            "col0": ["123", "1", "2", "3"],
            "col1": ["456", "5.67", "0", ".45"],
...
def test_column_data_types_with_failing_conversion() -> None:
    df = pd.DataFrame(
        {
            "col0": ["123", "1", "2", "3"],
...
def test_column_data_types_with_large_numeric_values() -> None:
    df = pd.DataFrame(
        {
            "big_number": [
                10**14,
