...
class DashboardFilterStateController(Controller):
    ...
    async def create(
        ...
        event_logger.log("filter_state.create", object_ref=f"dashboard:{pk}", user_id=current_user.id)
        return {"key": key}
    ...
    async def update(
        ...
        event_logger.log("filter_state.update", object_ref=f"dashboard:{pk}/key:{key}", user_id=current_user.id)
    ...
    async def delete_state(
        ...
        await cmd.execute()
        event_logger.log("filter_state.delete", object_ref=f"dashboard:{pk}/key:{key}", user_id=current_user.id)
        return {"message": "OK"}
