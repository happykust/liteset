...
from liteset.commands.dataset import (
...
class DatasetController(Controller):
    ...
    async def get_list(
        ...
        from liteset.db.filters import dataset_access_filters
    ...
    async def create(
        ...
        event_logger.log("dataset.create", object_ref=f"dataset:{dataset.id}", user_id=current_user.id)
        return DatasetGetResponse(
            id=dataset.id,
    ...
    async def update(
        ...
        dataset = await cmd.execute()
        event_logger.log("dataset.update", object_ref=f"dataset:{pk}", user_id=current_user.id)
        return DatasetGetResponse(
            id=dataset.id,
            result={"table_name": dataset.table_name},
        )
    ...
    async def delete_dataset(
        ...
        await cmd.execute()
        event_logger.log("dataset.delete", object_ref=f"dataset:{pk}", user_id=current_user.id)
        return {"message": "OK"}
    ...
    async def bulk_delete(
        ...
        await cmd.execute()
        event_logger.log("dataset.bulk_delete", user_id=current_user.id, extra={"count": len(ids)})
        return {"message": "OK"}
    ...
    async def duplicate(
        ...
        dataset = await cmd.execute()
        event_logger.log("dataset.duplicate", object_ref=f"dataset:{dataset.id}", user_id=current_user.id)
        return DatasetGetResponse(
            id=dataset.id,
            result={"table_name": dataset.table_name},
        )
    ...
    async def get_or_create(
        ...
        dataset = await cmd.execute()
        event_logger.log("dataset.get_or_create", object_ref=f"dataset:{dataset.id}", user_id=current_user.id)
        return DatasetGetResponse(
            id=dataset.id,
            result={"table_name": dataset.table_name},
        )
    ...
    async def delete_column(
        ...
        await cmd.execute()
        event_logger.log("dataset.delete_column", object_ref=f"dataset:{pk}/column:{column_id}")
        return {"message": "OK"}
    ...
    async def delete_metric(
        ...
        await cmd.execute()
        event_logger.log("dataset.delete_metric", object_ref=f"dataset:{pk}/metric:{metric_id}")
        return {"message": "OK"}
