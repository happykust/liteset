...
from liteset.providers import provide_report_dao
from liteset.schemas.report import ReportSchedulePostSchema, ReportSchedulePutSchema
...
class ReportScheduleController(Controller):
    ...
    async def related(
        ...
        return await get_related_payload(
            ...
            allowed_fields=frozenset({"owners", "created_by", "chart", "dashboard", "database"}),
        )
