...
from liteset.exceptions import LitesetValidationException, ObjectNotFoundError
from liteset.guards.rbac import require_authentication
from liteset.providers import provide_datasource_dao
from liteset.typing import DatasourceDAOProtocol
...
class DatasourceController(Controller):
    ...
    async def get_datasource(
        ...
        try:
            ...
            raise LitesetValidationException(str(exc)) from exc
